...
{
    public class InfiniteListScrollBehavior : Behavior<ListView>
    {
        ListView _listView;

        public static readonly BindableProperty LoadMoreCommandProperty =
            BindableProperty.Create(nameof(LoadMoreCommand), typeof(ICommand), typeof(InfiniteListScrollBehavior), null);
